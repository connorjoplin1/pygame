...
fiboball_img = pygame.image.load(os.path.join("Physics/Fib.webp")).convert_alpha()
fiboball_img = pygame.transform.scale(
    fiboball_img,
    (int(fiboball_img.get_width() / 10), int(fiboball_img.get_height() / 10))
)

million_img = pygame.image.load(os.path.join("Physics/1milli.webp")).convert_alpha()
